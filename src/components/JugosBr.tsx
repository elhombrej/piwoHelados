...
import { juiceFlavorsArrayBr } from "./Flavors";
  ...
  return (
    ...
    /> */}
          ...
          <Grid item xs={10}>
            ...
            >
              Nossos sucos são adoçados com <b>Stevia</b> e são de origem{" "}
              <b>100% natural</b>. Eles não contêm{" "}
              <b>corantes, conservantes ou açúcares</b>.
            </p>
          </Grid>
          ...
          >
            {juiceFlavorsArrayBr.map((element) => {
              return (
                <Grid
                  item
                  xs={12}
