...
import { shakesFlavorsArrayEn } from "./Flavors";
...
function BatidosEn(props: Props) {
      ...
      >
        ...
        >
          ...
          >
            ...
            <h1 style={{ fontSize: 100 }}> SHAKES</h1>
            <br />
          </Box>
          ...
          <Grid item xs={10}>
            ...
            >
              Selection of <b>fruits</b> for our{" "}
              <b>milkshakes, smoothies, or shakes with ice cream</b> made on the
              spot.
            </p>
          </Grid>
          ...
          >
            {shakesFlavorsArrayEn.map((element) => {
              return (
                <Grid
                  item
                  xs={12}
